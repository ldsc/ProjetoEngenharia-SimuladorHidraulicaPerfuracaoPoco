...
{
    std::string terminal_std_old = terminal_std;             // Armazena o nome do terminal antigo
                                                        // Muda o terminal
    ...
    this->replot();                                     // Replota o gráfico, agora salvando o arquivo ps
                                                        // Retorna o terminal para o padrão anterior
    Terminal(terminal_std_old);                         // Retorna o nome do terminal (corrigir!)
